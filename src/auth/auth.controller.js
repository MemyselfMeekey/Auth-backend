...
const { myEvent, sendOtp } = require("../eventlisteners/mainevent")
const AppError = require("../apperror")
const bcrypt = require("bcrypt")
const { genRanStr, genRanOtp } = require("../random/randomstrgenerator")
...
class AuthController{
    registration = async (req, res, next) => {
		try {
			const data = await services.transformRegisterData(req.body)
